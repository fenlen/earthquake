class TsunamisController < ApplicationController
  ...
  private
    ...
    def tsunami_params
      params.require(:tsunami).permit(:Date, :Time, :SameDayAs, :FocalDepth, :Magnitude, :Country, :Location, :Latitude, :Longitude, :MaximumWaterHeight, :Deaths, :Injuries, :DamageInMillions, :HousesDestroyed, :HausesDamaged)
    end
end
