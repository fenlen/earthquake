...
RSpec.describe "tsunamis/new", type: :view do
  before(:each) do
    assign(:tsunami, Tsunami.new(
      :SameDayAs => "MyString",
      :Focal_Depth => 1,
  ...
  it "renders new tsunami form" do
    render

    assert_select "form[action=?][method=?]", tsunamis_path, "post" do
